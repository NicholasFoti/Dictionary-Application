...
//Word Struct
//Structures and holds the information for each word with seperate fields
//Input: Information from .txt file
//Output: None
...
//Written by: Nicholas Foti
//Date Created: 29/03/2023
void findZWords(vector<Word>& dictionary)
{
...
void addWord(vector<Word>& dictionary)
{
	//Print a message if the dictionary has not yet been loaded and parsed
	if (dictionary.empty())
	{
